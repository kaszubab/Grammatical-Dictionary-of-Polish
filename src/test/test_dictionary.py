...
class DictionaryTests(unittest.TestCase):
    def test_export_import(self):
        test_dict = dictionary.Dictionary(["test_file.txt"])
        dictionary.Dictionary.export_dict(test_dict, "test_file.pickle")
        imported_dict = dictionary.Dictionary.import_dict("test_file.pickle")
